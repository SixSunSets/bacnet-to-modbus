...
def escribir_registro_modbus(host, port, unit_id, direccion_hex):
    ...
    if c.open():
        ...
        regs = c.write_single_register(address, 22)  # address: velocidad del ventilador / 1=baja, 2=media, 3=alta
...
port = 502
unit_id = 10
direccion_hex = "0x0102" #0x0101= estado, 0x0101= velocidad, 0x0102: Setpoint, 0x0105: Temperatura
